...
export const layupData: ProjectDetailData = {
  ...
  footerId: 3,
  intro:
    "소상공인이 반복적인 SNS 마케팅 작업을 자동화할 수 있도록 AI 기반 자동 포스팅과 성과 분석 리포트를 제공하는 SNS 마케팅 자동화 서비스",
  scrollAnchor: {
  ...
  roles: [
    {
      ...
      solution: [
        ...
        "**Dynamic Import**: 초기 진입 시 편집기 관련 대용량 로직 로드를 제거하여 첫 화면 로딩 부담 감소",
    ...
    },
    {
      ...
      problem: [
        "모바일로 촬영한 이미지를 PC로 이동 후 업로드해야 하는 구조로 인해 현장에서 이미지 관리 및 업로드 과정의 사용자 불편 발생",
      ],
      solution: [
        "**PWA 기반 모바일 이미지 드라이브 구축**: 별도 앱 설치 없이 모바일 환경에서 촬영 이미지의 즉시 업로드·관리 가능하도록 개선하여 접근성과 사용 편의성 강화",
      ],
