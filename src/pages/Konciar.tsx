        ...
        <section className="my-6" aria-labelledby="detail-content">
          ...
          <article className="mb-12">
            ...
            <p className="text-sm font-nexon text-font-color leading-relaxed">
              ...
              실제 창업을 준비하는 팀의 개발과  참여하여, 현재 <strong>프로토타입 개발 및 비즈니스 가설 검증</strong> 단계로, <strong>실제 서비스 출시</strong>를 목표로 고도화 중입니다.
              <br />
              초기 HTML기반 코드를 React 아키텍처로 전면 리팩토링하여 향후 확장성을 확보했으며, 서버리스 환경 구축을 통해 운영 비용 최소화와 개발 속도 극대화를 동시에 실현했습니다.
            </p>
          </article>
