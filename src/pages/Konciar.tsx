  ...
  const roles: RoleProps[] = [
    {
      ...
      problem: ["비구조화된 초기 코드베이스로 인한 기능 확장 및 유지보수의 한계", "복잡한 상태 관리에 따른 어려움 및 느린 개발 속도", "기대치보다 낮은 Lighthouse 스코어"],
      solution: [
      ...
      result: [
        ...
        "Lighthouse 스코어(Accessibility, Best Practices, SEO) 100점 달성",
