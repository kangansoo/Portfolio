...
const Experience = forwardRef<HTMLElement>((_, ref) => {
  const expData = [
    {
      ...
      achievements: [
        {
          title: "2학기 공통(첫 번째) 프로젝트 우수상",
          description: "페어프로그래밍을 위한 웹 IDE 및 관리 시스템",
        },
        {
          title: "2학기 자율(세 번째) 프로젝트 우수상",
      ...
      achievements: [
        {
          title: "최종 프로젝트 대상",
          description:
            "프롬프트 엔지니어링을 활용한 개인화 맞춤형 VOD 추천 서비스",
        },
      ],
    },
  ];
  ...
  return (
    <section
      ref={ref}
      className="w-full pt-10 pb-20 flex justify-center items-center select-none"
