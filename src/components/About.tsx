    ...
    <div className="w-full h-full flex justify-center items-center select-none">
      <div className="w-[60%] h-[80%] flex flex-col justify-center">
        ...
        <div className="w-full flex flex-col font-nexon text-font-color/80 text-sm mt-5">
          <p>
            좋은 서비스란 사용자가 <Strong fontSize="md">믿고 쓸 수 있는</Strong> 서비스라고 생각합니다. 이러한 믿음은 언제나 일관적되게 작동하는 <Strong fontSize="md">안정성</Strong>, 직관적이고
            편리한 <Strong fontSize="md">사용성</Strong> 그리고 사용자에게 최적의 경험을 제공하는 <Strong fontSize="md">편의성</Strong>에서 나온다고 믿습니다. 저는 이 세 가지 요소를 개발 철칙으로
