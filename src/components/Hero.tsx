...
const Hero = ({ showLanding }: HeroProps) => {
  ...
  return (
    <section
      className="w-full py-12 md:py-30 flex flex-col justify-center items-center text-font-color font-nexon font-normal"
      aria-label="자기소개 섹션"
    >
      ...
      <div className="mt-4 relative px-8 text-center">
        {/* 레이아웃 시프트 방지용 공간 */}
        <div
          className="invisible select-none leading-relaxed"
          aria-hidden="true"
        >
          {fullText}
        </div>
