...
const Skills = forwardRef<HTMLElement>((_, ref) => {
  const skillCategories = [
    {
      title: "Strong",
      items:
        "JavaScript / React.js / Next.js / Redux / React-Query / TypeScript / HTML5 / CSS / Tailwindcss / Styled Components / Java / WebSocket / i18n",
    },
    {
      title: "Experienced",
      items:
    ...
    {
      title: "Etc",
      items: "Figma / Git / Jira / AWS / GCP / GitHub Actions",
    },
  ];
  ...
  return (
    <section
      ref={ref}
      className="w-full py-10 flex justify-center items-center select-none"
